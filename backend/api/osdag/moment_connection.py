...
from api.osdag.component import Bolt, Weld, Plate, Angle, Beam, Column, ISection, RHS, SHS, CHS
from api.osdag.Common import *
from api.osdag.load import Load
from api.osdag.material import Material
from api.osdag import common_calculation
from api.osdag.is800_2007 import IS800_2007
import numpy as np
import logging
...
class MomentConnection(Connection, IS800_2007):
    ...
    def set_input_values(self, design_dictionary):
        ...
        self.load = Load(shear_force=design_dictionary.get(KEY_SHEAR, 0), axial_force=design_dictionary.get(KEY_AXIAL, 0),
                         moment=design_dictionary.get(KEY_MOMENT, 0))
